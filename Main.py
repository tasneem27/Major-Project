    ...
    def OpenFile(self, filename=None):
        ...
        if filename == "" or ext not in formats:
            ...
            if os.path.isfile(base + '.' + 'srt'):
                ...
                #command='audio2srt.py -i ' + base + '.wav -o ' + base + '.srt -- -lm C:\Python27\Lib\site-packages\pocketsphinx\model\en-in\en-us.lm.bin -hmm C:\Python27\Lib\site-packages\pocketsphinx\model\en-in\en-in -dict C:\sphinx\pocketsphinx\model\en-in\en_in.dict'
                print command
                subprocess.call(command, shell=True)
